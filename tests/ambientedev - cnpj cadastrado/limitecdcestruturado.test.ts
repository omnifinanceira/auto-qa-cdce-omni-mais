...
test.describe("suite de teste capital de giro", () => {
  ...
  test.only("Limite CDC Estruturado - Implantação", async ({ page }) => {
    test.slow();
    await page.goto("/");
    ...
    await page.waitForResponse(
      (response) =>
        response
          .url()
          .includes(
            "/limite-cdc-estruturado/api/proposals/new?cnpj=10313830276977"
          ) && response.status() === 200
    );
    ...
    await page
      .locator(
        '[data-placeholder="Percentual de MMJ (Multa, Mora e Juros) (%)"]'
      )
      .pressSequentially("6");
    ...
    await page
      .locator('[data-placeholder="Data da visita"]')
      .fill(formattedDate);
    ...
    await page
      ...
      .fill(formattedDate);
    await page
      .getByLabel("Segmento de atuação *")
      .locator("div")
      .nth(3)
      .click();
    await page.getByText("Acabamentos Finos").click();
    await page
      .getByLabel("Histórico junto à OMNI")
      .locator("div")
      .nth(2)
      .click();
    ...
    await page
      ...
      .fill("876");
    await page
      .getByLabel("Opera com crediário próprio")
      .locator("span")
      .click();
